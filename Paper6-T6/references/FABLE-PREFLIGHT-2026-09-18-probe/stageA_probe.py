...
HERE = Path('/Users/mzpi/Library/CloudStorage/GoogleDrive-Mohd.Zulhilmi@monash.edu/My Drive/Research/01 CollabProject-MonashIIUM/Imaging-Medical/Paper6-T6/code'); HAND = Path('/Users/mzpi/Library/CloudStorage/GoogleDrive-Mohd.Zulhilmi@monash.edu/My Drive/Research/01 CollabProject-MonashIIUM/Imaging-Medical/Paper6-T6/cfd_handover/stageA'); OUT = Path('/Users/mzpi/Library/CloudStorage/GoogleDrive-Mohd.Zulhilmi@monash.edu/My Drive/Research/01 CollabProject-MonashIIUM/Imaging-Medical/Paper6-T6/references/FABLE-PREFLIGHT-2026-09-18-probe')
...
df = pd.DataFrame(rows); df.to_csv(OUT / "expected_0D_probe.csv", index=False)
pd.set_option("display.width", 220); print(df.round(4).to_string(index=False)); print("wrote probe copy")
